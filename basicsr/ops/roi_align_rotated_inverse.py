...
from basicsr.ops import _C


class _ROIAlignRotatedInverse(Function):

    @staticmethod
    def forward(ctx, grad_output, rois, output_size, spatial_scale, sampling_ratio, input_shape):
...
roi_align_rotated_inverse = _ROIAlignRotatedInverse.apply


class ROIAlignRotatedInverse(nn.Module):
    def __init__(self, output_size, spatial_scale, sampling_ratio):
        ...
        """
        super(ROIAlignRotatedInverse, self).__init__()
        self.output_size = output_size
        self.spatial_scale = spatial_scale
        self.sampling_ratio = sampling_ratio

    def forward(self, input, rois, out_shape):
        """
        Args:
            input: NCHW images
        ...
        # grad_output, rois, output_size, spatial_scale, sampling_ratio, input_shape

        return roi_align_rotated_inverse(
            input, rois, self.output_size, self.spatial_scale, self.sampling_ratio, out_shape
        )
